...
export function parseSimpleBindingValue(s: string, ptr: { x: number }): BindingValue {
...
export function parseComplexBindingValue(left: BindingValue, s: string, ptr: { x: number }): BindingValue {
    if (s[ptr.x] === ',') {
...
export function parseBindingGroup(lines: string[], ptr: { y: number }): BindingGroup {
